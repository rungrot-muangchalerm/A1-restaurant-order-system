  ...
  res.status(200).json({
    ...
    menu: [
      ...
      },
      {
        id: "2",
        Image:
          "https://images.unsplash.com/photo-1628430043175-0e8820df47c3?auto=format&fit=crop&fm=jpg&q=70&w=900",
    ...
    promotion: [
      {
        ...
        discription:
          "ไช้ได้ทั้งทานที่ร้านและกลับบ้าน เงื่อนไขแสดงตอนยืนยันออเดอร์",
      },
      {
        id: "2",
      ...
      },
      {
        ...
        discription:
          "เมื่อสั่งเมนูหลัก 2 รายการขึ้นไป เหมาะกับโต๊ะเล็กและออฟฟิศ",
      },
    ],
  });
});
    ...
    reviews: [
      {
        ...
        rate: "5.00",
        message:
          "สแกนโต๊ะแล้วสั่งเองได้เลย เห็นว่าอาหารกำลังปรุงหรือพร้อมเสิร์ฟแล้ว ไม่ต้องเรียกพนักงานบ่อย",
        user: "คุณเมย์",
      ...
      },
      {
        ...
        rate: "4.50",
        message:
          "เมนูมีรูป ราคา และรายละเอียดชัดดี สั่งกลับบ้านแล้วรู้เวลารับอาหารโดยประมาณ",
        user: "คุณนนท์",
      ...
      },
      {
        ...
        rate: "5.00",
        message:
          "แวะหลังเลิกงานแล้วสั่งเมนูเดิมได้ไว ไม่ต้องจำชื่อเมนูยาว ๆ อาหารออกเร็วเหมือนเดิม",
        user: "คุณต้น",
        where: "ลูกค้าประจำ",
      },
    ],
  ...
  res.status(200).json({
    ...
    menu: [
      ...
      },
      {
        id: "20",
        Image:
          "https://cdn.pixabay.com/photo/2022/02/06/07/00/thai-tea-6996378_640.jpg",
        name: "ไก่ทอดสมุนไพร",
      ...
      },
      {
        ...
        name: "ชุดอิ่มคู่",
        discription:
          "เมนูหลัก 2 รายการ ของทานเล่น 1 รายการ และเครื่องดื่ม 2 แก้ว",
        price: "299",
        category: "ชุดเซ็ต",
      },
      {
